            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li><s:a namespace="/DireccionEconomicoFinanciera" action="ExpedientesList">Expedientes a completar</s:a></li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><s:a namespace="/DireccionEconomicoFinanciera" action="newPasswordForm">Cambiar contraseña</s:a></li>
                            <li><s:a namespace="/DireccionEconomicoFinanciera" action="logout">Salir</s:a></li>
                            </ul>
                        </li>
                    </ul>
                    <s:form action="Consultar" id="searchSolicitud" namespace="/DireccionEconomicoFinanciera" cssClass="navbar-form navbar-right" theme="simple">
