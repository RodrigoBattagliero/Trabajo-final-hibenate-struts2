            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li><s:a namespace="/Tesoreria" action="index">Inicio</s:a></li>
                        <li><s:a namespace="/Tesoreria" action="ExpedientesList">Expedientes a completar</s:a></li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><s:a namespace="/Tesoreria" action="newPasswordForm">Cambiar contraseña</s:a></li>
                            <li><s:a namespace="/Tesoreria" action="logout">Salir</s:a></li>
                            </ul>
                        </li>
                    </ul>
                    <s:form action="Consultar" id="searchSolicitud" namespace="/Tesoreria" cssClass="navbar-form navbar-right" theme="simple">
