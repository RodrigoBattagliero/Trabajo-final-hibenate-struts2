                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><s:a namespace="/SecretariaAdministrativoFinanciera" action="newPasswordForm">Cambiar contraseña</s:a></li>
                            <li><s:a namespace="/SecretariaAdministrativoFinanciera" action="logout">Salir</s:a></li>
                            </ul>
                        </li>
                    </ul>
                    <s:form action="Consultar" id="searchSolicitud" namespace="/SecretariaAdministrativoFinenciera" cssClass="navbar-form navbar-right" theme="simple">
